      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        >
          <div className="flex items-center gap-5 mb-16">
            <span className="font-mono text-xs text-black/25 tracking-[0.2em] uppercase">01.</span>
            <h2 className="text-3xl md:text-4xl font-bold text-black tracking-tight">About Me</h2>
            <div className="h-px bg-black/8 flex-grow max-w-xs hidden md:block" />
          </div>

          <div className="grid grid-cols-1 lg:grid-cols-5 gap-14 items-start">
            <div className="lg:col-span-3 space-y-5 text-black/55 text-base md:text-lg leading-relaxed">
              <p>
              ...
              <p>
                ...
                <span className="text-black font-medium">Bloomer</span>, building a video-first
                e-commerce platform. Off-screen: badminton, cricket, Sudoku, and music.
              </p>

              <div className="pt-4 border-t border-black/6">
                <p className="font-mono text-xs text-black/30 uppercase tracking-widest mb-4">Recent Tech</p>
                <ul className="grid grid-cols-2 gap-y-2 gap-x-4 font-mono text-sm">
                  {['JavaScript (ES6+)', 'React', 'Node.js', 'Express.js', 'Python', 'Django'].map((tech) => (
                    <li key={tech} className="flex items-center gap-2 text-black/50">
            ...
            >
              <div className="relative group">
                <div className="absolute -inset-2 border border-black/5 rounded-sm transition-all duration-500 group-hover:-inset-3" />
                <div className="relative overflow-hidden rounded-sm border border-black/10 aspect-square">
                  <img
                    src="/raghava.webp"
                ...
                <div className="mt-3 text-center font-mono text-[10px] text-black/25 tracking-widest uppercase">
